...
{
    public class ProductAddedToCartEmailStrategy : IProductAddedToCartEmailStrategy
    {
        private readonly SendGridConfiguration _sendGridConfiguration;
        public ProductAddedToCartEmailStrategy(IOptions<SendGridConfiguration> sendGridConfiguration)
        {
        ...
        public async Task Send(string userName, string email, string body)
        {
            ...
            var subject = "Product Added To Cart!";
